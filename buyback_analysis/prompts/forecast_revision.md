...
- `prev_forecast_date` は文書内のどの位置に記載されていても（表の前・本文の後など）見落とさず抽出してください。「○年○月○日に公表した」「（○年○月○日発表）」などの表現を探してください。本日の開示日と混同しないでください。令和表記（例：令和7年5月10日）は西暦に変換してください（令和元年=2019年、令和2年=2020年、…令和7年=2025年、令和8年=2026年）。記載がなければ `null` にしてください。
