...
- buyback_completion：自己株式の取得が終了したこと、取得実績を報告している文書。消却完了は含めない。**自社が他社の買付けに応じた文書は `other` を使用すること（方法が公開買付けか市場買付けかを問わない）。具体例：「〇〇株式会社による自己株式の公開買付けへの応募結果」「他社からの公開買付けに応募した結果」「〇〇株式会社による自己株取得への応募に係る株式売却」など。**
